...
/**
 * Contains method used to decode a String representing text in Morse code.
 * The String must use the following format:  '.' = dot; '-' = dash; '|' = space
 * Any other characters will be replaced with a blank space.
 * @author kensandala
 *
 */
...
{
	/**
	 * Unused constructor, all methods are static
	 */
	public MorseDecoder()
	{
	...
	{
		morse = morse.replace("…", "...");	//Replace any ellipsis character with three dots
		String result = "";
		String morseChar = "";
		int pos = 0;
