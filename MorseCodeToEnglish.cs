...
namespace MorseCodeToEnglish
{
    public class Program
    {
        static void Main(string[] args)
        {
            //assumption is that the first argument is the file
            string filename;
            try
            {
                filename = args[0];
            ...
            {
                translateMorseToEnglish(filename);
            }
            else
            {
        ...
        private static void translateMorseToEnglish(string filename)
        {
